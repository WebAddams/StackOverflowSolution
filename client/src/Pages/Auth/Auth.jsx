    ...
    <section className='auth-section'>
      ...
      <div className='auth-container-2'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type='submit' className='auth-btn'>{ isSignup ? 'Singn up': 'Log in'}</button>
          {
            isSignup && (
              <p style={{ color: "#666767", fontSize: "13px"}}>
                By clicking “Sign up”, you agree<br /> to our <span style={{ color: "#007ac6"}}>terms of service, privacy<br />
                policy</span> and <span style={{ color: "#007ac6"}}>cookie policy.</span>
              </p>
            )
          }
        </form>
